...
<html lang="en">
  ...
  <body>
	...
	<!-- START nav -->
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">BOBA<small>witch</small></a> <!--nanti bisa di ganti logo ??-->
            ...
            <li class="nav-item"><a href="menu.html" class="nav-link">Menu</a></li>
	        	...
	        	<li class="nav-item acti cart">
					...
					<span class="bag d-flex justify-content-center align-items-center">
						<small>0</small> <!--ini nanti mungkin bisa diatur biar sesuai bnyk ny yg dipesen-->
					</span></a>
				</li> 
                ...
                <li class="nav-item dropdown cart">
					...
					<div class="dropdown-menu" aria-labelledby="dropdown04">
						<a class="dropdown-item" data-toggle="modal" data-target="#myModalNorm">Login</a>
                        <a class="dropdown-item" data-toggle="modal" data-target="#myModalNorm2">Register</a>
					</div>
                </li>  -->
                <!--user profile nav-->
                <li class="nav-item">
                    <a href="profile.html"><img src="gambar/Jennie.jpg" width="40px" height="40px" style="border-radius: 50%;" ></a>
                </li>
			</ul>
	      </div>
		  </div>
  ...
  <!-- END nav -->
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url(gambar/bg1.jpg);">
      ...
      <div class="slider-item" style="background-image: url(gambar/bg2.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
      ...
      <div class="slider-item" style="background-image: url(gambar/bg3.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
    ...
    <section class="ftco-section ftco-services">
			<div class="container">
			  ...
			  <!-- <div class="col-md-4 ftco-animate">
				<div class="media d-block text-center block-6 services">
				  <div class="icon d-flex justify-content-center align-items-center mb-5">
					  <span class="flaticon-bubble-milk-tea"></span></div>
				  <div class="media-body">
    ...
    <section class="ftco-about d-md-flex">
    	...
    	<div class="one-half ftco-animate">
    		<div class="overlap">
	        <div class="heading-section ftco-animate ">
	        	<span class="subheading">resto uas</span>
	          <h2 class="mb-4">Our Story</h2>
	        </div>
	        <div>
	  				<p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country. But nothing the copy said could convince her and so it didn’t take long until a few insidious Copy Writers ambushed her, made her drunk with Longe and Parole and dragged her into their agency, where they abused her for their.</p>
    				...
    				<div class="row">
    					<div class="col-md-6">
    						<div class="menu-entry">
		    					<a href="#" class="img" style="background-image: url(gambar/milktea.jpg);"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
		    					<a href="#" class="img" style="background-image: url(gambar/freshmilk.jpg);"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry">
		    					<a href="#" class="img" style="background-image: url(gambar/matcha.jpg);"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
		    					<a href="#" class="img" style="background-image: url(gambar/kuki.jpg);"></a> <!--ini nanti dibawa ke halaman menu HREF nya-->
		    				</div>
    					</div>
    				</div>
    			</div>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
          	<span class="subheading">favouritesr</span>
            <h2 class="mb-4">Our Menu Recommendation</h2>
        ...
        <div class="row">
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					<a href="#" class="img" style="background-image: url(gambar/freshmilk.jpg);"></a>
    					<div class="text text-center pt-4">
    						<h3><a href="#">Boba Fresh Milk</a></h3>
    						<p>A small river named Duden flows by their place and supplies</p>
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					<a href="#" class="img" style="background-image: url(gambar/kuki.jpg);"></a>
    					<div class="text text-center pt-4">
    						<h3><a href="#">Choco Chip Cookie</a></h3>
    						<p>A small river named Duden flows by their place and supplies</p>
  ...
  <div class="container">
			  ...
			  <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
				<div class="block-18 text-center">
				  <div class="text">
					  ...
					  <span>BOBA Witch's Branches</span>
				  </div>
				</div>
			  </div>
			  <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
	    		...
	    		<div class="col-lg-12 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
		            <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
		              ...
		              <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">Foods</a>
		            </div>
		          </div>
		              ...
		              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
		              	<div class="row">
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(gambar/milktea.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Boba Milk Tea</a></h3>
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(gambar/matcha.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Boba Fresh Milk</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>Rp. 21.000</span></p>
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(gambar/kuki.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Choco Chip Cookie</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>Rp. 24.000</span></p>
    ...
    <footer class="ftco-footer ftco-section img">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-3 col-md- mb-4 mb-md-5-2">
          ...
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5-2">
            <div class="ftco-footer-widget mb-4">
