...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form-group row">
                <label for="tgllahir" class="col-sm-2 col-form-label">Birth Date</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="tgllahir" name="tgllahir" value="<?= $user['tgl_lahir']; ?>" readonly>
                </div>
            </div>
            <div class="form-group row">
